require.config({
    paths: {
        ...
        'lightbox': 'https://preview-mmvue.codecloudapp.com/lightbox',
    ...
    const vm = new Vue({
        ...
        data: function() {
            return {
                ...
                stickyMenu: false,
                isSticky: 350,
                subdomain: "prairiemall",
                twitter_user: "prairiemall"
            }
        },
        created() {
        ...
        methods: {
            loadData: async function() {
                try {
                    await this.$store.dispatch('initializeApi', { site: "prairiemall", version: "v4" });
