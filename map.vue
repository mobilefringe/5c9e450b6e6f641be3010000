<template>
	<div v-if="dataloaded">
	    <div class="page_header" v-if="pageBanner" :style="{ backgroundImage: 'linear-gradient(180deg, rgba(0,0,0,0) 0%, rgba(0,0,0,0.6) 61.52%, rgba(0,0,0,0.8) 100%), url(' + pageBanner.image_url + ')' }">
		...
		<div class="map_container site_container clearfix">
		    <div class="row visible_phone">
		        <div class="col-sm-12 margin_30">
                    <p class="text_left">Find A Store :</p>
