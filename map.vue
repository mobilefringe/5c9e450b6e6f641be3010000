<template>
	<div v-if="dataloaded">
	    <div class="page_header" v-if="pageBanner" :style="{ backgroundImage: 'linear-gradient(180deg, rgba(0,0,0,0) 0%, rgba(0,0,0,0) 61.52%, rgba(0,0,0,0.8) 100%), url(' + pageBanner.image_url + ')' }">
